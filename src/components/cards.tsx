    ...
    return (
        ...
        <Card className="bg-white rounded-xl shadow-xl border-gray-100">
          ...
          <CardContent>
            ...
            <CardDescription className="text-zinc-800">Monitored game servers</CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white rounded-xl shadow-xl border-gray-100">
          ...
          <CardContent>
            ...
            <CardDescription className="text-zinc-800 mt-2">Latest database sync</CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white rounded-xl shadow-xl border-gray-100">
          ...
          <CardContent>
            ...
            <CardDescription className="text-zinc-800">Total data stored</CardDescription>
          </CardContent>
        </Card>
